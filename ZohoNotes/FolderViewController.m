...
-(void) addGestureRecognizerToCollectionView
{
    ...
    [self.folderCollectionView addGestureRecognizer:tapGesture];
}
...
- (void)configureCell:(UITableViewCell *)cell withFolder : (Folder *) folder {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"No. of Notes :%lu", folder.notes.allObjects.count ];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    folderCollectionViewCell.numberOfNotesLabel.text = [NSString stringWithFormat:@"No. of Notes :%lu", folder.notes.allObjects.count ];
    
    folderCollectionViewCell.folderNameLabel.font = [UIFont titleFont];
    folderCollectionViewCell.numberOfNotesLabel.font = [UIFont descriptionFont];
    ...
    if (isDelete)
    {
        ...
        folderCollectionViewCell.layer.shouldRasterize = YES;
        [folderCollectionViewCell.layer addAnimation:anim forKey:@"SpringboardShake"];
        [folderCollectionViewCell.deleteButton setHidden:NO];
    }
    else
    {
        [folderCollectionViewCell.deleteButton setHidden:YES];
    }
